...
/**
 * The Account section has been removed from the default markup, since `wporg-two-factor` creates a separate
 * Account screen. That screen contains the contents that would be here, and also Two Factor settings.
 */
...
<form id="bbp-your-profile" method="post" enctype="multipart/form-data">
	...
	<fieldset class="bbp-form">
		<div>
			Security and language settings can be changed on <a href="<?php bbp_user_profile_edit_url(); ?>account/">the Account screen</a>.
		</div>
	</fieldset>
	...
	<fieldset class="submit">
		...
		<div>
			...
			<?php // This is necessary to pass the validation in bbp_get_displayed_user_field( 'user_email', 'raw' );  ?>
